...
class FurnActionsStorage extends Model
{
    protected $fillable = [
        'furn_storage_id', 'type_id', 'user_id', 'reason', 'count'
    ];
    ...
    {
        return $query->with(['type', 'user', 'furnStorage'])->where('furn_storage_id', $id)->orderBy('created_at', 'DESC');
    }
}
