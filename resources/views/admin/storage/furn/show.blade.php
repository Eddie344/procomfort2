                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('label', $furn->label, ['class' => 'form-control', 'required']) }}
                                    </div>
                                    <div class="form-group">
                                        {{ Form::label('unit', 'Единица измерения:') }}
                                        {{ Form::text('unit', $furn->unit, ['class' => 'form-control', 'required']) }}
                                    </div>
                                </div>
                                    ...
                                    <div class="modal fade" id="edit_{{ $part->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                {{ Form::open(['route' => ['furn_part.update', $part->id], 'method' => 'put']) }}
                                                {{ Form::token() }}
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::number('count', null, ['class' => 'form-control', 'step' => "0.001", 'required']) }}
                                                    </div>
                                                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <form id="date_container">
                                <div class="input-group">
                                    {{ Form::open(['route' => ['furn.index', $furn->id], 'method' => 'get']) }}
