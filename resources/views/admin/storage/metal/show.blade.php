            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-6"><h4>{{ $metal->label }}</h4></dd>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="edit_{{ $part->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                {{ Form::open(['route' => ['metal_part.update', $part->id], 'method' => 'put']) }}
                                                {{ Form::token() }}
                                    ...
                                    <div class="modal fade" id="delete_{{ $part->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                            <div class="modal-content">
                                                {{ Form::open(['route' => ['metal_part.destroy' , $part->id], 'method' => 'delete']) }}
                                                {{ Form::token() }}
                                                {{ Form::hidden('metal_storage_id', $metal->id) }}
                        ...
                        <div class="col-md-9">
                            <form id="date_container">
                                <div class="input-group">
                                    {{ Form::open(['route' => ['metal.index', $metal->id], 'method' => 'get']) }}
