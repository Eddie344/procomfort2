    ...
    <div>
        ...
        >
            <template v-slot:cell(label)="data">
                <a :href="'/admin/storage/vert/'+ data.item.id">{{ data.item.label }}</a>
            </template>
...
<script>
    export default {
        ...
        methods:{
            load(){
                this.isBusy = true;
                axios.post('/admin/storage/vert/getAll')
                    .then((response) => {
            ...
            editItem() {
                this.actionLoad = true;
                axios.put('/admin/storage/vert/'+this.editingModal.item_id, {
                    item: {
            ...
            deleteItem(){
                this.actionLoad = true;
                axios.delete('/admin/storage/vert/'+this.deletingModal.item_id)
                    .then((response) => {
                        this.load();
                        this.actionLoad = false;
